      ...
      <table>
        <thead class="color">
          <tr>
            <th colspan="7" class="color">
              ...
              <div>
                  <a href="april.php"><i class="fas fa-caret-left icon color"></i></a>
                  <p id="cal-month">May</p>
                  <a href="june.php"><i class="fas fa-caret-right icon color"></i></a>
        ...
        <tbody id="table-body" class="border-color">
          ...
          <tr>
            ...
            <tr>
            <td>31<ul id="31" onclick="show('31')"></ul></td>
            <td></td>
            <td></td>
            <td></td>
            <td></td>
